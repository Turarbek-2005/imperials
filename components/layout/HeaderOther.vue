...
<template>
  <Container>
    <div class="header">
      <NuxtLink to="/"
        ><NuxtImg src="/logo-blue.svg" width="47px" alt=""
      /></NuxtLink>
      <LayoutSidebarOther v-if="!tabletView" />
      <div class="networks">
        <NuxtLink class="network" href="https://www.instagram.com/">
          <NuxtImg src="/instagram-black.svg" alt="instagram" height="19px" />
        </NuxtLink>
        <NuxtLink class="network" href="https://www.tiktok.com/">
          <NuxtImg src="/tiktok-black.svg" alt="tiktok" height="19px" />
        </NuxtLink>
        <NuxtLink class="network" href="https://telegram.org/">
          <NuxtImg src="/telegram-black.svg" alt="telegram" height="19px" />
        </NuxtLink>
        <label>RU</label>
      </div>
